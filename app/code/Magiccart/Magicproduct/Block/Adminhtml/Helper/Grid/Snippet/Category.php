...
class Category extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $shortcodeWidget = $this->_escaper->escapeHtml('{{widget type="Magiccart\Magicproduct\Block\Widget\Category" identifier="' . $identifier . '" template="category.phtml"}}');
        $shortcodeBlock  = $this->_escaper->escapeHtml('<?= $block->getLayout()->createBlock(\'Magiccart\Magicproduct\Block\Widget\Category\')->setIdentifier("' . $identifier . '")->setTemplate(\'category.phtml\')->toHtml(); ?>');
