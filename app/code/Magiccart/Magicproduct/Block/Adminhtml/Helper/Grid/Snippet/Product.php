...
class Product extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $shortcodeWidget = $this->_escaper->escapeHtml('{{widget type="Magiccart\Magicproduct\Block\Widget\Product" identifier="' . $identifier . '" template="product.phtml"}}');
        $shortcodeBlock  = $this->_escaper->escapeHtml('<?= $block->getLayout()->createBlock(\'Magiccart\Magicproduct\Block\Widget\Product\')->setIdentifier("' . $identifier . '")->setTemplate(\'product.phtml\')->toHtml(); ?>');
